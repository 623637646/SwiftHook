...
public extension ClassInstanceHook {
    /**
     ...
     Example usage:
     ```swift
     try ClassInstanceHook(NSTextField.self).hookBefore(all: \.stringValue) { textfield, stringValue in
        // hooks before.
     }
     ```
     */
    ...
    /**
     ...
     Example usage:
     ```swift
     try ClassInstanceHook(NSTextField.self).hookBefore(set: \.stringValue) { textfield, stringValue in
        // hooks before
     }
     ```
     */
    ...
    /**
     ...
     Example usage:
     ```swift
     try ClassInstanceHook(NSTextField.self).hookAfter(\.stringValue) { textfield, stringValue in
        // hooks after.
     }
     ```
     */
    ...
    /**
     ...
     Example usage:
     ```swift
     try ClassInstanceHook(NSTextField.self).hookAfter(set: \.stringValue) { textfield, stringValue in
        // hooks after.
     }
     ```
     */
    ...
    /**
     ...
     Example usage:
     ```swift
     try ClassInstanceHook(NSTextField.self).hook(\.stringValue) { object, original in
    ...
    /**
     ...
     Example usage:
     ```swift
     try ClassInstanceHook(NSTextField.self).hook(set: \.stringValue) { textfield, stringValue, original in
        if stringValue != "" {
